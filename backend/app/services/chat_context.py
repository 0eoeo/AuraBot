...
class ChatContextManager:
    ...
    def _build_horoscope_prompt(self, planets: list[request_models.Planet]) -> str:
        ...
        return (
            "Ты астролог. Положение планет в гороскопе:\n\n"
            f"{formatted}\n\n"
            "На основе этого положения составь короткий гороскоп для всех 12 знаков зодиака на сегодня.\n"
            "Для каждого знака укажи, как эти планеты повлияют на его день. Пиши на русском языке.\n"
