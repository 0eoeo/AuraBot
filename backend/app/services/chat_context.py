...
class ChatContextManager:
    ...
    def _build_horoscope_prompt(self, planets: list[request_models.Planet]) -> str:
        ...
        return (
            ...
            f"{formatted}\n\n"
            "На основе этого положения составь забавный короткий гороскоп для всех 12 знаков зодиака на сегодня.\n"
            "Для каждого знака укажи, как эти планеты повлияют на его день. Пиши на русском языке, с приколами.\n"
            "Формат ответа: '♈ Овен: ...', '♉ Телец: ...' и так далее по всем знакам. Не выводи лишних комментариев."
        )
